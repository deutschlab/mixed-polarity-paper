...
[FlyWire Codex download page](https://codex.flywire.ai/api/download?dataset=fafb).
Derived `.ftr` / `.pkl` tables are generated by the processing pipeline and are not committed.
See [data/README.md](data/README.md) and [docs/data_availability.md](docs/data_availability.md)
for the full list of required files and where to obtain them.
...
| [docs/diagrams/](docs/diagrams/) | Pipeline flowcharts in Mermaid, SVG, and PNG formats |
